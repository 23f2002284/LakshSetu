...
//     try{
//     const profileData = {
//     //   id: Date.now(), // Would be generated by backend
...
//       blogs: formData.blogs.length > 0 ? formData.blogs : null,
...
//         const data = await fetch("http://127.0.0.1:8000/registration", {
//           method: "POST",
//           headers: {
...
//     }catch(err){
//         console.error(" Failed to operate registration process",err)
//     }
//   }
